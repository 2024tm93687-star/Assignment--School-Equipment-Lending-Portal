...
const ProtectedRoute: React.FC = () => {
  ...
  return isAuthenticated ? (
    <Container fluid className="min-vh-100 d-flex flex-column p-0">
      <Header title="School Equipment Lending Portal"/>
      ...
      <Footer heading={"Group 8 Team Members"} members={COLLABORATORS as FooterProps['members']} copyright={<span>&copy; {new Date().getFullYear()} School Equipment Lending Portal</span>}/>
    </Container>
  ) : (
